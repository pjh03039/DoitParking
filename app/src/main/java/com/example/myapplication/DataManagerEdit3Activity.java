...
import com.example.myapplication.databinding.ActivityDatamanageredit3Binding;
...
public class DataManagerEdit3Activity extends AppCompatActivity implements View.OnClickListener {
    private ActivityDatamanageredit3Binding binding;
    ...
    private static String selectedParkingNo;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDatamanageredit3Binding.inflate(getLayoutInflater());
        ...
        Button btnEditComplete = binding.btnEditComplete;
        ...
        btnEditComplete.setOnClickListener(this);

        Query query = parkingDatabase.orderByChild("주차장관리번호").equalTo(selectedParkingNo);
        if (selectedParkingNo != null && !selectedParkingNo.equals("")) {
            btnEditComplete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(getApplicationContext(), "주차장 도면을 수정중입니다.", Toast.LENGTH_LONG).show();
    ...
    public static void recevieEdit3(String ParkingNo) {
        selectedParkingNo = ParkingNo;
    }
}
